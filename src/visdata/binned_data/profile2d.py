...
# class Profile2dPlotConfigMean:
#     """Config class for Profile2dPlot mean."""
#     quantity = "mean"
#     xerr = 0
#     yerr = "sem"
#     color = "r"
...
# class Profile2dPlotConfigMedian(Profile2dPlotConfigMean):
#     """Config class for Profile2dPlot mean."""
#     quantity = "median"
#     yerr = 0
#     color = "deeppink"
...
# def add_profile2d_to_axis(ax, xcenter, mean, sem, std, median, configs=None):
#     """Add profile2d plot to given axis."""
#     if configs is None:
#         configs = (Profile2dPlotConfigMean(), Profile2dPlotConfigMedian())
...
#         if yerr or config.xerr:
#             ax.errorbar(
#                 xcenter,
#                 data,
#                 xerr=config.xerr,
#                 yerr=yerr,
#                 fmt=f"{config.color}{config.marker}",
#                 markersize=config.markersize,
#                 elinewidth=config.linewidth,
#                 capsize=config.capsize,
#             )
